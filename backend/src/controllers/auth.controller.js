...
//  *               - Type: Object.
//  *               - Required: Yes.
//  *               - Description: The Express request object containing the reset token and new password.
//  *           - res:
//  *               - Type: Object.
//  *               - Required: Yes.
//  *               - Description: The Express response object used to send responses to the client.
...
//  *           2. Finds the user by the reset token and ensures the token is not expired.
//  *           3. Hashes the new password and updates the user's record.
//  *           4. Clears the reset token and expiration time from the user's record.
//  *           5. Sends a password reset success email to the user.
//  *           6. Sends a success response indicating the password has been reset.
//  *       - Error Handling:
//  *           - Returns appropriate error messages for invalid tokens, expired tokens, or server issues.
//  *
//  * Usage:
...
export { signup } from "./signup.controller.js";
export { login, logout } from "./login.controller.js";
export { verifyEmail } from "./emailVerification.controller.js";
